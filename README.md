...
- [About](#about)
- [List of Problems no with Problem title](#list_of_problem)
- [Usage](#usage)
...
This challange is adopted from [freecodecamp](https://www.freecodecamp.org/learn/coding-interview-prep/project-euler/) where this challenge was introduced with Javascript. Here I am trying to use java for solving the problems.

## List of Problems no with Problem title <a name = "list_of_problem"></a>
